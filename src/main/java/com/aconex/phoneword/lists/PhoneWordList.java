...
import com.aconex.phoneword.dictionaries.Dictionary;
 ...
 */
public class PhoneWordList extends AbstractNumberList {
    ...
    /**
     * Initialize the {@link PhoneWordList} with the required components, load the dictionary,
    ...
    private static void start(final String pathToDictionaryFile, final String pathToInputFile){
        ...
        if (!englishDictionary.load(pathToDictionaryFile))
            System.exit(1);
        ...
        PhoneWordList encodedPhoneNumberList = new PhoneWordList(
                new PhoneNumberValidator(EnglishParameters.MAX_PHONE_NUMBER_LENGTH),
                englishDictionary,
